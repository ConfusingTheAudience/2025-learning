...
# --------------------------------------------------------------------
# FILE UPLOAD HANDLE WITH POST
# --------------------------------------------------------------------

# in html name is important in forms
...
# --------------------------------------------------------------------
# RETURN A FILE 2 (WITH DOWNLOAD TEMPLATE)
# --------------------------------------------------------------------

# we need import os
# we need import uuid
# we need import send_from_directory
...
# import jsonify
# here id in html button is important because we working on it to communicate with backend
